...
public class LineChartManager {
     ...
     * 初始化LineChart
     */
    private void initLineChart(boolean legendShow) {//参数决定是否显示图例
...
//        leftAxis.setGridColor(Color.parseColor("#d8d8d8"));
        leftAxis.setGridColor(Color.BLUE);//横向线
//        leftAxis.setAxisLineColor(Color.parseColor("#d5d5d5"));
        leftAxis.setTextColor(Color.BLUE);//左边y轴刻度文字颜色
...
//        lineDataSet.setFormSize(15.f);
    ...
    public void showLineChart(List<Float> xAxisValues, List<Float> yAxisValues, String label, int color) {
        ...
        initLineDataSet(lineDataSet, color, false);//数据与标签，颜色，颜色是否填充折线下方
...
//        xAxis.setTextColor(Color.parseColor("#a1a1a1"));
        xAxis.setTextColor(Color.BLUE);//x轴刻度文字颜色
